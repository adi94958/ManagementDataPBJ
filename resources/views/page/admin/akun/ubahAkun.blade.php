                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    @else
                                    <img class="elevation-3" id="prevImg" src="{{ asset('vendor/adminlte3/img/user.png') }}" width="150px" />
                                    @endif
                                </div>
                                <div class="col-md-8">
                ...
                <div class="card card-secondary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input placeholder="Ketik ulang kata sandi" id="password-confirm" type="password" class="form-control" name="password_confirmation" required="required" autocomplete="new-password">
                        </div>
                    </div>
                    <!-- /.card-body -->
                </div>
