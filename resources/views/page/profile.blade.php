@extends('layouts.base_admin.base_dashboard') @section('judul', 'Halaman Profil') @section('content')
                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        <div class="text-center">
                            ...
                            @else
                            <img
                                src="{{ asset('vendor/adminlte3/img/user.png') }}"
                                class="profile-user-img img-fluid img-circle"
                                alt="User Imagess">
                            @endif
                        </div>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="updateData">
                                <div class="row">
                                    <div class="col-md-6">
                                        <form action="{{ route(Auth::user()->role . '.profile.update',['type'=>'change_profile']) }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                    ...
                                    <div class="col-md-6">
                                        <form action="{{ route(Auth::user()->role . '.profile.update',['type'=>'change_password']) }}" method="post">
                                            @csrf
